...
// Include controllers if necessary
...
<div class="login-container">
    <div class="form-box">
        <h3 class="fw-bold mb-3 pb-3 fs-1">Log in</h3>
        <form method="POST">
            <!-- Email Input -->
            ...
            <!-- Submit Button -->
            <div class="pt-1 mb-4">
                <button class="btn btn-lg w-100" style="background: #938f84;" type="submit" name="btn-now-login">Login</button>
            </div>
            
            <!-- Forgot password and registration link -->
            <p>Did not receive the email? <a href="ResentEmail.php" class="link-info"  >Resend the link</a></p>
            <p>Forgot Password? <a href="PasswordReset.php" class="link-info"  >Forgot Password</a></p>
