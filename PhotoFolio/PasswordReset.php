...
?>
    ...
    <div class="login-container">
      <div class="form-box">
        <h3 class="fw-bold mb-3 pb-3 fs-3">Password Reset</h3>
        <form method="POST">
          <!-- Email Input -->
          ...
          <!-- Submit Button -->
          <div class="pt-1 mb-4">
            <button class="btn  btn-lg w-100" type="submit" style="background: #938f84;" name="password-reset-btn">Send Password Reset Link</button>
          </div>
