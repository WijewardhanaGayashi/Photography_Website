...
<html lang="en">
  ...
  <body>
    ...
    <div class="login-container">
      <div class="form-box">
        <h3 class="fw-bold mb-3 pb-3 fs-3">Reset Password</h3>
        <form method="POST">
          ...
          <!-- Password Input -->
          <div class="form-outline mb-4">
            <label class="fs-6" for="email">New Password</label>
            <input type="password" id="new_password" name="new_password" class="form-control form-control-lg" />
          </div>
          
          <!-- Password Input -->
          <div class="form-outline mb-4">
            <label class="fs-6" for="password">Confirmed Password</label>
            <input type="password" id="password" name="password" class="form-control form-control-lg" />
          </div>

          <!-- Submit Button -->
          <div class="pt-1 mb-4">
            <button class="btn  btn-lg w-100" type="submit" style="background: #938f84;" name="update-password-btn">Update</button>
          </div>
